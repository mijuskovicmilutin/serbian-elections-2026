...
**Status (2026-09-21):** gotovi V1.0–V1.6, V2 (vesti, sa logotipima portala na početnoj), V3.0 (Polymarket), V3.1 (relayout početne) i V3.2 (model i javni API anketa). Sledeći korak: V3.3 (admin pregled: interni endpointi + `/admin/istrazivanja`).

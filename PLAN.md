...
**Status (2026-09-21):** gotovi V1.0–V1.6, V2 (vesti, sa logotipima portala na početnoj), V3.0 (Polymarket), V3.1 (relayout početne), V3.2 (model i javni API anketa) i V3.3 (admin pregled anketa). Sledeći korak: V3.4 (otkrivanje objava po agencijama, uz ručni unos kao pun put) ili V3.5 (FE prikaz anketa na početnoj i `/istrazivanja`).

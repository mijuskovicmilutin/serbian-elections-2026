...
**Status (2026-09-21):** gotovi V1.0–V1.6, V2 (vesti, sa logotipima portala na početnoj), V3.0 (Polymarket), V3.1 (relayout početne), V3.2 (model i javni API anketa), V3.3 (admin pregled anketa) i V3.5 (prikaz anketa na početnoj i `/istrazivanja`). Sledeći korak: V3.4 (otkrivanje objava po agencijama; ručni unos već radi) i V3.6 (prekidač izborne tišine, posle pravne provere). **Pre objave prve prave ankete proveriti pravilo o izbornoj tišini.**
